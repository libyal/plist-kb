...
class YAMLPropertyListDefinitionsFileTest(test_lib.BaseTestCase):
    ...
    def testReadPropertyListDefinition(self):
        ...
        test_definitions_file = yaml_definitions_file.YAMLPropertyListDefinitionsFile()

        definitions = test_definitions_file._ReadPropertyListDefinition(self._TEST_YAML)
        ...
        self.assertEqual(
            definitions.property_list_identifier, "com.apple.airport.preferences.plist"
        )
        ...
        with self.assertRaises(RuntimeError):
            test_definitions_file._ReadPropertyListDefinition({"bogus": "test"})
    ...
    def testReadFromFile(self):
        ...
        self.assertEqual(
            definitions[0].artifact_definition, "MacOSAirportPreferencesPlistFile"
        )
