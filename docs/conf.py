...
# Change PYTHONPATH to include plistrc module and dependencies.
sys.path.insert(0, os.path.abspath('..'))

import plistrc  # pylint: disable=wrong-import-position
...
project = 'Property List file knowledge base'
copyright = 'The Property List file knowledge base authors'
version = plistrc.__version__
release = plistrc.__version__
...
def RunSphinxAPIDoc(app):
  ...
  module_path = os.path.join(current_directory, '..', 'plistrc')
